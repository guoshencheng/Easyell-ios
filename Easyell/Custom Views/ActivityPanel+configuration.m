...
- (void)configureTableView {
    ...
    self.activityPanelDatasource.configureActivityPanelBlock = ^(UITableViewCell *cell, NSDictionary *activity) {
        if ([cell isKindOfClass:[ActivityPanelMemberCell class]]) {
            [(ActivityPanelMemberCell *)cell updateWithMemberArray:weakSelf.members];
        } else {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ActivityPanelMemberCell" bundle:nil] forCellReuseIdentifier:MEMBER_CELL];
}
